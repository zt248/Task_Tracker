...
<table cellspacing="2" border="1" cellpadding="5" width="600">
    ...
    <tr>
        ...
        <td><a href="<c:url value="/manager/Task${task.id}CreateComment" /> ">
            <button>Добавить комментарий</button>
        </a></td>
        <td><a href="<c:url value="/manager/managerUpdateTask${task.id}Status"/> ">
...
<table cellspacing="2" border="1" cellpadding="5" width="300">
    ...
    <form:forEach items="${task.comments}" var="comments">
        <tr>
            ...
            <td><a href="<c:url value="/manager/managerUpdateComment${comments.id}Page/${task.id}" /> ">
                <button>Редактировать комментарий</button>
            </a></td>
            <td><a href="<c:url value="/manager/managerDeleteComment${comments.id}/${task.id}" /> ">
